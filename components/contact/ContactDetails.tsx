...
const ContactDetails = () => {
  return (
    <div className=" loctionform md:block w-1/2 bg-primary text-secondary p-[40px] flex flex-col gap-14 rounded-l-[10px] xs:rounded-l-[0px] xs:rounded-t-[10px] items-center justify-center">
